    ...
    try:
        while True:
            if role == "CLP1":
                ...
                # Controla a bomba de captação da barragem
                bomba_ligada = nivel_tanque < 50  
                data_bank.set_coils(BOMBA_CAPTACAO_ADDRESS, [bomba_ligada])
